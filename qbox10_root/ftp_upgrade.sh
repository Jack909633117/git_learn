...
# ftp ip & port
ftpIp="59.42.52.138"
ftpIpBak="mtxy.hi-target.com.cn"
ftpPort="15009"
# ftp user
ftpUser="M20DEV"
# ftp log path
...
download()
{
    ...
    $wget -t 2 -T 10 ftp://$ftpUser@$ftpIp:$ftpPort/$1 -O $2 -o $tmpPath/wget.log
    # $wget -t 2 -T 10 ftp://$ftpUser@$ftpIp/$1 -O $2 -o $tmpPath/wget.log
    ...
    then
        ...
        $wget -t 2 -T 10 -q ftp://$ftpUser@$ftpIpBak:$ftpPort/$1 -O $2
        # $wget -t 2 -T 10 -q ftp://$ftpUser@$ftpIpBak/$1 -O $2
    fi
}
...
{
    # -q [quit]
    $wput -t 2 -T 10 $1 ftp://$ftpUser@$ftpIp:$ftpPort/$2 -o $tmpPath/wput.log
    # $wput -t 2 -T 10 5 $1 ftp://$ftpUser@$ftpIp/$2 -o $tmpPath/wput.log
    ...
    then
        ...
        $wput -t 2 -T 10 -q $1 ftp://$ftpUser@$ftpIpBak:$ftpPort/$2
        # $wput -t 2 -T 10 -q $1 ftp://$ftpUser@$ftpIpBak/$2
    fi
}
